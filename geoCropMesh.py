...
# given a dive origin and geotiff file path function returns xmin,xmax,ymin,ymax to crop a section out of the mesh with
def meshCropPts(olon,olat,gtfpath):
